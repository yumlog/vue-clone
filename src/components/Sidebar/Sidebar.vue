    ...
    <aside>
      ...
      >
        <div class="info-wrap">
          <div class="ico-profile">
            <img
              src="@/assets/images/icon_32/squircle_32x32_reflexion.png"
              alt="프로필"
            />
          </div>
          <div class="info-area">
          ...
          >
            ...
            <ul class="submenu">
              ...
              <li
                ...
                :key="sub.index"
                :class="sub.children ? 'dropdown expand' : ''"
              >
      ...
      <div class="btns-wrap">
        ...
        <button class="btn-close" @click="$emit('close', $event)">
          <img
            inline
            src="@/assets/images/icon_24/appbar_close.svg"
            aria-hidden="true"
          />
